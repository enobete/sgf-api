...
return [
    ...
    */
    'resources' => [
        'provincias' => \App\Provincia::class,
        'tipo_docs' => \App\TipoDoc::class,
        'cidadaos' => \App\Cidadao::class,
        'pedidos' => \App\Pedido::class,
        'cabines' => \App\Cabine::class,
        'filas' => \App\Pedido::class,
